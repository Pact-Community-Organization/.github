...
> Organization-wide default. A repository may publish its own `CODE_OF_CONDUCT.md`,
> which takes precedence for that repository.
...
to the community leaders responsible for enforcement at **info@pact-community.org**.
